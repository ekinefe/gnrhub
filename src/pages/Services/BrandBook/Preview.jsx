...
const BrandPreview = () => {
    ...
    const handleSendToHub = async (e) => {
        ...
        // 1. Construct the HTML (Keep your existing HTML string generation code here)
        const htmlMessage = `... your beautiful HTML string ...`;

        // 2. Send to YOUR Backend (Cloudflare Function)
